                                        ...
                                        <div class="guests">
                                            ...
                                            <div class="form-group children">
                                                ...
                                                <div class="popover-icon" data-container="body" data-toggle="popover"
                                                     ...
                                                     data-content="0 till 18 years"><i class="fa fa-info-circle fa-lg"> </i>
                                                </div>
...
@section('list')
    ...
    @for ($i = 0; $i < count($hotels['hotels']); $i++)

        {{ $hotels["hotels"][$i]["name"] }},
        {{ $hotels["hotels"][$i]["zoneName"]  }} |

        @for ($y = 0; $y < count($hotels["hotels"][$i]["rooms"]); $y++)
            {{ $hotels["hotels"][$i]["rooms"][$y]["name"] }}
            {{ $hotels["hotels"][$i]["rooms"][$y]["rates"]["0"]["net"] }}
        @endfor
        <br>
    @endfor
